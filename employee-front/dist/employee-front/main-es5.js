...
module.exports = "<nav class=\"navbar navbar-expand-sm\" style=\"background: #0086ff; \">\n  <!-- Links -->\n  <ul class=\"navbar-nav\">\n    <li class=\"nav-item\">\n        <a routerLink=\"employees\" class=\"nav-link\" routerLinkActive=\"active\">Employees</a>\n    </li>\n    <li class=\"nav-item\">\n        <a routerLink=\"add\" class=\"nav-link\" routerLinkActive=\"active\">Add</a>\n    </li>\n  </ul>\n</nav>\n<div class=\"container\">\n  <br>\n  <h1 style=\"text-align: center;\">{{title}}</h1>\n  <hr>  \n  <div class=\"card\">\n    <div class=\"card-body\">\n  <router-outlet></router-outlet>\n    </div>\n  </div>\n</div>\n\n<footer class=\"footer\">\n  <div class=\"container\">\n      <span>All Rights Reserved 2019 @JamalMalik</span>\n  </div>\n</footer>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Welcome to employee-front!';
    }
...
/* harmony import */ var _create_employee_create_employee_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./create-employee/create-employee.component */ "./src/app/create-employee/create-employee.component.ts");
...
var CreateEmployeeComponent = /** @class */ (function () {
    ...
    CreateEmployeeComponent.prototype.onSubmit = function () {
        if (this.employee.name.length < 1 || this.employee.email.length < 1 || this.employee.department.length < 1) {
            return;
        }
        this.submitted = true;
        this.save();
...
module.exports = __webpack_require__(/*! /Users/cesarrodriguez/Documents/workspace-sts-3.9.4.RELEASE/employee/employee-front/src/main.ts */"./src/main.ts");
